...
function tampilkanKlasemen(data) {
    ...
    data.standings[0].table.forEach(standing => {
        ...
        if (standing.team.crestUrl) {
            logo = `https://ahmadjaini7.github.io/laliga-workbox.github.io/js/logo/${standing.team.id}.png`;
        }
        standings += `
                <tr>
...
function tampilkanKlubs(data1) {
    ...
    data1.teams.forEach(team => {
        let logo = "";
        if (team.crestUrl) {
            logo = `https://ahmadjaini7.github.io/laliga-workbox.github.io/js/logo/${team.id}.png`;
        }
        teams += `
            ...
            <a href="https://ahmadjaini7.github.io/laliga-workbox.github.io/team.html?id=${team.id}">
            <img src="${logo}">
            </a>
            </div>
...
function tampilkanTeam(data2) {
    let logo = "";
    if (data2.crestUrl) {
        logo = `https://ahmadjaini7.github.io/laliga-workbox.github.io/js/logo/${data2.id}.png`;
    }
    let detailTeam = `
                                <div class="container">
                                <h4 class="heading">Informasi Team</h4>
                                <a class="heading" href="https://ahmadjaini7.github.io/laliga-workbox.github.io/index.html#saved">TIM di simpan</a>
    ...
    getAll()
        .then((teams) => {
            ...
            teams.forEach(team => {
                ...
                <div class="card">
                <div class="card-image">
                <a href="https://ahmadjaini7.github.io/laliga-workbox.github.io/team.html?id=${team.id}&saved=true">
                <img src="${logo}">
                </a>
                </div>
                <div class="card-action">
